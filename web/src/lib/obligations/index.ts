...
/**
 * Which obligations apply to a system, given its Module 1 outputs. Pure
 * lookup over `category` — adding/changing an obligation never touches this
 * function, matching the "rules as data" principle.
 *
...
export function getApplicableObligations(system: {
  ...
  const applicable = obligationCatalog.filter((o) => o.category === "GENERAL");
